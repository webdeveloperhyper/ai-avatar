...
- 💃 **Animations** — play `.vrma` motion clips or custom JSON poses; 4-state button: off / Default / Random / Custom *(v2, v7)*
...
- 💃 **アニメーション** — `.vrma`モーションクリップやカスタムJSONポーズを再生；4段階ボタン：オフ / デフォルト / ランダム / カスタム *(v2, v7)*
